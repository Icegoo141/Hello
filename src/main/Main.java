        ...
        while (!GameController.getInstance().checkGameEnd()) {
            ...
            while (true) {
                ...
                if (option == 0) {
                    ...
                    System.out.println("======================================================");
                    if (GameController.getInstance().players.isEmpty()) {
                    ...
                    System.out.println("======================================================");
                    if (GameController.getInstance().monsters.isEmpty()) {
                    ...
                    if (choice == 1) {
                        if (GameController.getInstance().markets.get(market).getFoods().isEmpty()) {
                    ...
                    System.out.println("======================================================");
                    if (GameController.getInstance().players.isEmpty() || GameController.getInstance().monsters.isEmpty()) {
                    ...
                    if (GameController.getInstance().players.get(player).getPotions().isEmpty()) {
                    ...
                    if (GameController.getInstance().players.get(player).getFoods().isEmpty()) {
